...
export const ConfigSidebar = ({
  ...
  return (
    <div className="md:w-1/3 lg:w-1/4 space-y-6">
      <Card className="bg-gradient-to-br from-gray-900 to-gray-800 shadow-lg border-none text-white">
        <CardHeader className="pb-3">
          <CardTitle>Configure Your Offering</CardTitle>
          <CardDescription className="text-gray-300">Customise what products and services you'd like to offer to your customers.</CardDescription>
        </CardHeader>
      </Card>

      {/* Target Customers */}
      <Card className="bg-gray-900 shadow-md hover:shadow-lg transition-shadow border-none text-white">
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            ...
            <Button variant="ghost" size="sm" className="h-8 w-8 p-0 text-gray-300 hover:text-white hover:bg-gray-800" onClick={() => setCustomersOpen(!customersOpen)}>
      ...
      <Card className="bg-gray-900 shadow-md hover:shadow-lg transition-shadow border-none text-white">
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            ...
            <Button variant="ghost" size="sm" className="h-8 w-8 p-0 text-gray-300 hover:text-white hover:bg-gray-800" onClick={() => setAssetsOpen(!assetsOpen)}>
      ...
      <Card className="bg-gray-900 shadow-md hover:shadow-lg transition-shadow border-none text-white">
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            ...
            <Button variant="ghost" size="sm" className="h-8 w-8 p-0 text-gray-300 hover:text-white hover:bg-gray-800" onClick={() => setMetersOpen(!metersOpen)}>
