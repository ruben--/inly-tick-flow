...
export const MainContent = ({
  ...
  return (
    <div className="w-full flex-grow p-0">
        ...
        <div className="p-4 overflow-y-auto" style={{ maxHeight: "calc(100vh - 180px)" }}>
          ...
          <div className="relative w-full h-[300px] mb-6 overflow-hidden border-2 border-black shadow-[4px_4px_0px_rgba(0,0,0,1)]">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-black/70 to-transparent flex flex-col justify-center p-8">
              ...
              <p className="text-white/90 text-base p-2 bg-te-orange/80 inline-block font-mono sidebar-collapse-text">
              ...
              {hasSelectedAssets ? (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {selectedAssetTypes.map(type => (
                    <Card 
                      key={type.id} 
                      className="flex overflow-hidden border-2 border-black rounded-none shadow-[2px_2px_0px_rgba(0,0,0,1)] hover:shadow-[4px_4px_0px_rgba(0,0,0,1)] hover:translate-x-[-1px] hover:translate-y-[-1px] transition-all"
                    >
                  ...
                  <Card className="overflow-hidden border-2 border-black rounded-none shadow-[2px_2px_0px_rgba(0,0,0,1)] hover:shadow-[4px_4px_0px_rgba(0,0,0,1)] hover:translate-x-[-1px] hover:translate-y-[-1px] transition-all">
                    <div className="h-40 bg-te-gray-100 relative">
                      <img 
                        ...
                        className="w-full h-full object-cover" 
                        src="/lovable-uploads/92486d5d-2202-48c8-ab14-f8f1a4c3c7ba.png" 
                      />
                      <div className="absolute top-2 right-2 bg-te-orange text-black px-2 py-1 font-mono text-xs border border-black">Active</div>
                    </div>
                    <CardContent className="p-4 border-t-2 border-black bg-white">
